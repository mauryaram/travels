                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-3">
                                                        <a href="<?= admin('faculty_add?id='.$value['id'])?>" class="text-success"><i class="mdi mdi-pencil font-size-18"></i></a>
                                                        <a href="<?= admin('faculty_list/delete?id='.$value['id'].'&img='.$value['image'])?>" class="text-danger"><i class="mdi mdi-delete font-size-18"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php $n++; }  }?>
