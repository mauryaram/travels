                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Our Pens</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Our Pens</a></li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-4">
                                        <form enctype="multipart/form-data" method="Post" action="<?= admin('Pen_add/saveup')?>">
                                            ...
                                            <div class="col-lg-12">
                                                <div>
                                                    ...
                                                    <div class="mb-3 col-6">
                                                        <label for="affiliation" class="form-label">Designation</label>
                                                        <input class="form-control" type="text" value="<?=$affiliation;?>" name="affiliation" id="affiliation">
                                                    </div>
                                                    <div class="mb-3 col-6">
