                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-4">
                                        <form enctype="multipart/form-data" method="Post" action="<?= admin('cms_add/saveup')?>">
                                            <input type="hidden" name="id" value="<?=!empty($data['id']) ? $data['id'] : "";?>">
                                            <input type="hidden" name="oldimg" value="<?=!empty($data['image']) ? $data['image'] : "";?>">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div>
                                                    <div class="mb-3">
                                                        <label for="meta_title" class="form-label">Meta Title</label>
                                                        <input class="form-control" type="text" value="<?=!empty($data['meta_title']) ? $data['meta_title'] : "";?>" name="meta_title" id="meta_title">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="meta_keyword" class="form-label">Meta Keyword</label>
                                                        <textarea class="form-control" name="meta_keyword" id="meta_keyword"><?=!empty($data['meta_keyword']) ? $data['meta_keyword'] : "";?></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="meta_description" class="form-label">Meta Description</label>
                                                        <textarea class="form-control" name="meta_description" id="meta_description"><?=!empty($data['meta_description']) ? $data['meta_description'] : "";?></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="meta_description" class="form-label">Schema</label>
                                                        <textarea class="form-control" name="schema" id="schema"><?=!empty($data['schema']) ? $data['schema'] : "";?></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="heading" class="form-label">Heading</label>
                                                        <input class="form-control" type="text" value="<?=!empty($data['heading']) ? $data['heading'] : "";?>" name="heading" id="heading">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="editor1" class="form-label">Description</label>
                                                        <textarea class="form-control" name="description" id="editor1"><?=!empty($data['description']) ? $data['description'] : "";?></textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 mb-3">
                                                        ...
                                                        <select class="form-control" name="status">
                                                            <option <?php if($data['status'] == 'Active'){echo 'selected';}?> value="Active">Acitve</option>
