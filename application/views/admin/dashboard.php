...
<html lang="en">
  ...
  <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<?=admin_assest('');?>images/favicon.ico">
        
        <!-- plugin css -->
        <link href="<?=admin_assest('');?>libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
    ...
    <body data-layout="horizontal" data-topbar="dark">
                                        ...
                                        <div class="px-3" data-simplebar style="max-height: 386px;">
                                            <div class="d-flex align-items-center pb-4">
                                                <div class="avatar-md me-4">
                                                    <img src="<?=admin_assest('');?>images/users/avatar-2.jpg" class="img-fluid rounded-circle" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center pb-4">
                                                <div class="avatar-md me-4">
                                                    <img src="<?=admin_assest('');?>images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center pb-4">
                                                <div class="avatar-md me-4">
                                                    <img src="<?=admin_assest('');?>images/users/avatar-5.jpg" class="img-fluid rounded-circle" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center pb-4">
                                                <div class="avatar-md me-4">
                                                    <img src="<?=admin_assest('');?>images/users/avatar-6.jpg" class="img-fluid rounded-circle" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center pb-4">
                                                <div class="avatar-md me-4">
                                                    <img src="<?=admin_assest('');?>images/users/avatar-8.jpg" class="img-fluid rounded-circle" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center pb-3">
                                                <div class="avatar-md me-4">
                                                    <img src="<?=admin_assest('');?>images/users/avatar-9.jpg" class="img-fluid rounded-circle" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                                ...
                                                <table class="table align-middle table-nowrap">
                                                    <tbody>
                                                        <tr>
                                                            <td style="width: 50px;">
                                                                <div class="avatar-md me-4">
                                                                    <img src="<?=admin_assest('');?>images/product/img-1.png" class="img-fluid" alt="">
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50px;">
                                                                <div class="avatar-md me-4">
                                                                    <img src="<?=admin_assest('');?>images/product/img-2.png" class="img-fluid" alt="">
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50px;">
                                                                <div class="avatar-md me-4">
                                                                    <img src="<?=admin_assest('');?>images/product/img-3.png" class="img-fluid" alt="">
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50px;">
                                                                <div class="avatar-md me-4">
                                                                    <img src="<?=admin_assest('');?>images/product/img-4.png" class="img-fluid" alt="">
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50px;">
                                                                <div class="avatar-md me-4">
                                                                    <img src="<?=admin_assest('');?>images/product/img-5.png" class="img-fluid" alt="">
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50px;">
                                                                <div class="avatar-md me-4">
                                                                    <img src="<?=admin_assest('');?>images/product/img-6.png" class="img-fluid" alt="">
                                                                </div>
                                                            </td>
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li>
                                                    <div class="conversation-list">
                                                        <div class="d-flex">
                                                            <img src="<?=admin_assest('');?>images/users/avatar-3.jpg" class="rounded-circle avatar-sm" alt="">
                                                            <div class="flex-1">
                                                ...
                                                <li class="right">
                                                    <div class="conversation-list">
                                                        <div class="d-flex">
                                                            ...
                                                            <img src="<?=admin_assest('');?>images/users/avatar-6.jpg" class="rounded-circle avatar-sm" alt="">
                                                        </div>
                                                                        ...
                                                                        <ul class="list-inline message-img mt-3  mb-0">
                                                                            <li class="list-inline-item message-img-list">
                                                                                <a class="d-inline-block m-1" href="#">
                                                                                    <img src="<?=admin_assest('');?>images/small/img-1.jpg" alt="" class="rounded img-thumbnail">
                                                                                </a>                                                                  
                                                                            </li>
                    
                                                                            <li class="list-inline-item message-img-list">
                                                                                <a class="d-inline-block m-1" href="#">
                                                                                    <img src="<?=admin_assest('');?>images/small/img-2.jpg" alt="" class="rounded img-thumbnail">
                                                                                </a>                                                                 
                                                                            </li>
                                                                        </ul>
                                                                    </div>
        ...
        <!-- apexcharts -->
        <script src="<?=admin_assest('');?>libs/apexcharts/apexcharts.min.js"></script>

        <!-- Plugins js-->
        <script src="<?=admin_assest('');?>libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="<?=admin_assest('');?>libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js"></script>
        <!-- dashboard init -->
        <script src="<?=admin_assest('');?>js/pages/dashboard.init.js"></script>
