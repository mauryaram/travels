                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Faculty</h4>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-4">
                                        <form enctype="multipart/form-data" method="Post" action="<?= admin('Faculty_add/saveup')?>">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-6 mb-3">
                                                        <label for="status" class="form-label">Profile Pic</label>
