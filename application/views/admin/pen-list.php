                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Pens</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Pens</a></li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Pens List</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tr>
                                                <td><?=$n?></td>
                                                <td><?=$value['heading']?></td>
                                                <td><img src="<?= img_url($value['image'])?>" style="height: 50px; width: 50px;"></td>
                                                <td><?=$value['status']?></td>
                                                <td>
                                                    <div class="d-flex gap-3">
                                                        <a href="<?= admin('pen_add?id='.$value['id'])?>" class="text-success"><i class="mdi mdi-pencil font-size-18"></i></a>
                                                        <a href="<?= admin('pen_list/delete?id='.$value['id'].'&img='.$value['image'])?>" class="text-danger"><i class="mdi mdi-delete font-size-18"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php $n++; }  }?>
