...
class Course_add extends CI_Controller {
	...
	public function index()
	{
            ...
            $data['title']  = ( !empty($id) ? 'Update' : 'Add') .' Course';
            $table          = 'dt_cms';
            $data['id']             = '';
            $data['page_type']      = '';
            $data['meta_title']     = '';
        ...
        public function saveup() {
            ...
            $supdate['page_type']           =  'course_category';
            ...
            $supdate['syllabus']            = !empty($post['syllabus']) ? $post['syllabus'] : '';
            ...
            redirect(admin('course_add?id='.$id));
            }else{
