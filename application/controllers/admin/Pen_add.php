...
class Pen_add extends CI_Controller {
	...
	public function index()
	{
            ...
            $data['title']  = ( !empty($id) ? 'Update' : 'Add') .' Pens';
            $table          = 'dt_cms';
            $data['id']             = '';
            $data['page_type']      = '';
            $data['meta_title']     = '';
            ...
            $this->load->view('admin/pen-add',$data);
	}
